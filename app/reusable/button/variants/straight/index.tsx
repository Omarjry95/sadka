...
export default function Straight({ width, height, minHeight, paddings, margins, color, borders, borderColor, borderStyle, radiuses, position, positionCoords, onPress,
                                     style, ChildComponent }: BaseStrictProps) {
