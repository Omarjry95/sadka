...
export default function Straight({ width, height, minHeight, paddings, margins, color, borders, borderColor, borderStyle, radiuses, position, positionCoords, disabled,
                                     onPress, style, ChildComponent }: BaseStrictProps) {
